...
class Employee
{
    ...
    {
        $this->db->query("INSERT INTO `employee details` (`employee number`, `last name`, `first name`, `middle name`, `birthdate`, `sex`, `phone number`, `position`) VALUES (:id, :lname, :fname, :mname, :birthdate, :sex, :phone, :position)");
