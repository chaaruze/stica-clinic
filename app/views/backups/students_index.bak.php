...
<style>
    ...
    .input-group.custom-search-container .form-control {
        border: none; /* Remove individual borders to let container handle it */
    }
    .custom-search-icon {
        color: var(--sti-blue);
    }
            ...
            <div class="row justify-content-center mb-4" style="position: relative; z-index: 2;">
                <div class="col-md-8 d-flex align-items-center justify-content-center gap-3">
                    ...
                    <div class="input-group custom-search-container" style="max-width: 500px;">
                         ...
                         <input type="text" id="customSearch" class="form-control" placeholder="Search Student ID, Name, or Course...">
                    </div>
                    ...
                    <tbody>
                        <?php foreach ($data['students'] as $student): ?>
                            <tr>
                                ...
                                <td style="cursor: pointer;" onclick="window.location.href='<?= URLROOT ?>/students/details/<?= $student->{'student number'} ?>'"><?= $student->{'course'} ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
...
<script>
    $(document).ready(function () {
        ...
        // Move DataTables Length Menu to Custom Container
