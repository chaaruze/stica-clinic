                ...
                <div class="card-body position-relative">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="fw-bold">
                                <?= !empty($data['student']->emergency_contact_name) ? htmlspecialchars($data['student']->emergency_contact_name) : 'N/A' ?>
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <span class="text-muted">Contact Phone</span>
                            <span class="fw-bold">
                                <?php if (!empty($data['student']->emergency_contact_phone)): ?>
                                    <a href="tel:<?= htmlspecialchars($data['student']->emergency_contact_phone) ?>" class="text-decoration-none">
                                        <i class="fas fa-phone me-1"></i><?= htmlspecialchars($data['student']->emergency_contact_phone) ?>
                                    </a>
                                <?php else: ?>
                                    N/A
                                <?php endif; ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="emergency_contact_name" 
                                value="<?= $data['student']->emergency_contact_name ?? '' ?>" placeholder="Parent/Guardian Name">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Contact Phone</label>
                            <input type="text" class="form-control" name="emergency_contact_phone" 
                                value="<?= $data['student']->emergency_contact_phone ?? '' ?>" placeholder="09XX-XXX-XXXX">
                        </div>
                    </div>
